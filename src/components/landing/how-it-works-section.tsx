...
const steps = [
  {
    ...
    description:
      'اشتراک هوش مصنوعی یا دیجیتال مورد نظر خود را انتخاب کرده و پرداخت را از طریق درگاه امن شاپرک در چند ثانیه انجام دهید.',
  ...
  },
  {
    ...
    title: 'تحویل فوری و خودکار',
    description:
      'بلافاصله پس از پرداخت موفق، مشخصات اشتراک، لینک اختصاصی فعال‌سازی یا لایسنس همراه با راهنمای شفاف در پنل کاربری شما قرار می‌گیرد.',
  ...
  },
  {
    ...
    title: 'فعال‌سازی سریع و امن',
    description:
      'با یک کلیک و بر اساس راهنما، اشتراک را با حفظ کامل حریم خصوصی مستقیماً روی اکانت شخصی خودتان فعال نمایید.',
    time: 'تنها با ۱ کلیک',
  },
]
      ...
      <div className='container relative mx-auto px-4 sm:px-6'>
        ...
        >
          ...
          <p className='text-sm leading-relaxed text-muted-foreground sm:text-base'>
            سریع، کاملاً خودکار و بدون نیاز به ارسال هرگونه اطلاعات حساس یا رمز عبور اکانت‌های شخصی شما
          </p>
        </motion.div>
            ...
            <div className='flex flex-col items-center gap-4 text-center sm:flex-row sm:items-start sm:text-right'>
              ...
              <div className='flex-1 space-y-1.5'>
                ...
                <p className='text-sm leading-relaxed text-muted-foreground'>
                  برای فعال‌سازی اشتراک‌ها، به هیچ وجه نیازی به ارسال پسورد، کدهای
                  ورود یا دسترسی به حساب شخصی شما نیست. تمامی فرآیندها کاملاً قانونی،
                  رسمی و با حفظ بالاترین استانداردهای امنیتی انجام می‌شود.
                </p>
              </div>
            </div>
          </motion.div>
