...
export function SupportTab() {
  return (
    ...
    >
      {/* Header Banner */}
      <motion.div variants={fadeUp} className="rounded-2xl border border-border/70 bg-gradient-to-br from-primary/5 via-card to-card p-4 sm:p-5">
          ...
          <Card className="border-border/70 shadow-xs hover:border-primary/40 transition-colors h-full">
            ...
            <CardContent className="px-5 pb-5 pt-0 space-y-3">
              ...
              <a href={`tel:${SUPPORT_PHONE}`} className="block">
                <Button
                  variant="outline"
                  className="w-full gap-2 text-xs font-semibold rounded-xl border-border/80 transition-transform active:scale-[0.98]"
                >
      ...
      <motion.div
        variants={fadeUp}
        className="rounded-xl border border-border/60 bg-muted/30 p-3.5 text-xs text-muted-foreground flex items-center gap-2.5"
      >
