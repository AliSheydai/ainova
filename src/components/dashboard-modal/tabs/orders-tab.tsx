  ...
  return (
    <div className="space-y-4">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-14 text-center rounded-2xl border border-dashed border-border/70 p-6 bg-muted/20">
          ...
          <Button
            onClick={() => {
              ...
              else window.location.href = '/dashboard/buy'
            }}
            className="mt-4 gap-2 text-xs font-semibold rounded-xl bg-gradient-to-r from-primary to-blue-600 shadow-md shadow-primary/20"
          >
        ...
        <div className="space-y-3">
          {orders.map((order) => {
            ...
            return (
              <Card
                key={order.id}
                className="overflow-hidden border border-border/70 shadow-xs transition-all hover:border-primary/30"
              >
