        ...
        <CardContent className='space-y-6 pt-2'>
          ...
          <div className='rounded-2xl border border-border/70 bg-muted/30 p-4 sm:p-5'>
            <div className='grid grid-cols-2 gap-3.5 text-xs'>
              ...
              <div>
                ...
                <span className='font-extrabold text-primary text-sm mt-0.5 block font-sans'>
                  {new Intl.NumberFormat('fa-IR').format(order.amount)} تومان
                </span>
              </div>
              <div>
                <span className='text-muted-foreground block text-[11px]'>شناسه سفارش:</span>
                <span className='font-sans font-bold text-foreground text-xs mt-0.5 block select-all'>
                  {order.id}
                </span>
              </div>
              <div>
                <span className='text-muted-foreground block text-[11px]'>کد پیگیری بانکی (RefId):</span>
            ...
            <div className='rounded-2xl border border-primary/30 bg-gradient-to-b from-primary/10 via-primary/5 to-transparent p-5 sm:p-6 shadow-sm space-y-4'>
              ...
              <div className='space-y-1.5'>
                ...
                <div className='flex items-center gap-2'>
                  <div
                    dir='ltr'
                    className='flex-1 p-3 rounded-xl border border-border/80 bg-background font-mono text-xs font-semibold select-all truncate'
                  >
          ...
          {isCompleted && deliveryType === 'CUSTOMER_PROVISIONING' && (
            <div className='rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-5 space-y-3'>
              ...
              {deliveryData.accountInfo && (
                <div className='p-3 rounded-xl bg-background/80 border border-emerald-500/20 text-xs font-mono' dir='ltr'>
                  {deliveryData.accountInfo}
                </div>
              )}
            </div>
          ...
          {isCompleted && deliveryType === 'MANUAL' && (
            <div className='rounded-2xl border border-primary/30 bg-primary/5 p-5 space-y-3'>
              ...
              <div className='text-xs text-foreground leading-relaxed whitespace-pre-line p-3 rounded-xl bg-background/90 border border-border/60'>
