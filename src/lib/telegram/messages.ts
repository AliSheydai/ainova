...
export const MESSAGES = {
  ...
  preCreatedDeliveryChoice: (planName: string, warehouseCount: number | null | undefined) => {
    ...
    const countText = hasInventory
      ? `✅ هم‌اکنون <b>${warehouseCount.toLocaleString('fa-IR')} اکانت آماده تحویل فوری</b> در انبار موجود است.`
      : `🕒 موجودی تحویل فوری انبار تمام شده است؛ سفارش شما ثبت و ظرف ۱ روز کاری ارسال خواهد شد.`

    return (
      `📦 <b>انتخاب شیوه تحویل — ${escapeHtml(planName)}</b>\n\n` +
      `${countText}\n\n` +
      `یکی از روش‌های زیر را جهت تحویل سفارش انتخاب نمایید:\n\n` +
      `۱. <b>اکانت اختصاصی آماده (${hasInventory ? 'تحویل فوری ۰ ثانیه' : 'ارسال طی یک روز کاری'}):</b>\n` +
      `مشخصات ورود به اکانت اختصاصی و نو، پس از پرداخت تحویل داده می‌شود.\n\n` +
      `۲. <b>فعال‌سازی روی جیمیل شخصی شما (۱ روز کاری):</b>\n` +
      `شارژ مستقیم روی جیمیل شخصی شما توسط کارشناسان پشتیبانی انجام می‌شود.\n\n` +
